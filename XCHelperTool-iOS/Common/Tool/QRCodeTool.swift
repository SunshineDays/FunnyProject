...
class QRCodeTool: NSObject {
    ...
    public class func qrCodeWithLogo(qrCodeData data: String,
                          ...
                          logoScaleToSuperView scale: CGFloat,
                                      isShowLogoJamb: Bool = false) -> UIImage?
    {
        ...
        if isShowLogoJamb {
            iconImage = addWatermakerImage(backgroundImage: #imageLiteral(resourceName: "share_background"), watermarkImage: logoImage, backgroundImageRect: CGRect(x: 0, y: 0, width: 110, height: 110), watermarkImageRect: CGRect(x: 5, y: 5, width: 100, height: 100))!
        } else {
            iconImage = logoImage
        }
