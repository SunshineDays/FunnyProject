...
class XCUserLoginController: BaseViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        wrSetNaviBar(isHiddenShadowImage: true, alpha: 0)
...
//
//        }
        let vc = InterfaceCtrl.authCodeController(phone: phoneTextField.text!, authCodeType: .register)
